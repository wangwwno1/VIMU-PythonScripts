...
if __name__ == "__main__":
    ...
    CSV_PATH = 'data/evaluation_reports/Moving vs Maneuver Overt Gyro - 08.15/full_detection_reports.csv'
    FILENAME = 'Time to Detect - Moving vs Maneuver.pdf'
    ...
    result_0 = result_0.loc[result_0['deviation'] >= 0.03]
